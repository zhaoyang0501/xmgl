...
public class CheckAction extends PageAction {
	private Long id;
	...
	@Action(value = "index", results = { @Result(name = "success", location = "/WEB-INF/views/admin/check/index.jsp") }) 
    public String index(){
	...
	public String list() {
		...
		Page<Apply> list = applyService.findAllForCheck(pageNumber, pageSize,project);
